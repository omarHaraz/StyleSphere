package com.StyleSphere.backend.settings.service;
...
import com.StyleSphere.backend.settings.model.StoreSettings;
import com.StyleSphere.backend.settings.repository.StoreSettingsRepository;
